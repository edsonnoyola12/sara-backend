...
# PASO 1: Agregar objeto de ubicaciones después de VIDEO_SERVER_URL
maps_object = """
...
# PASO 2: Agregar obtención del link ANTES de crear hipoteca
...
replacement = """      // Obtener link de Google Maps si existe
      const mapsLink = matchedProperty?.model ? (MAPS_UBICACIONES[matchedProperty.model] || '') : '';
...
print("✅ GPS agregado con objeto simple:")
print("  1. Objeto MAPS_UBICACIONES creado")
print("  2. Link obtenido por modelo")
print("  3. Link agregado en notificaciones")
print("  4. SIN imports, SIN archivos externos")
